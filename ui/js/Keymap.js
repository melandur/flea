...
var SHARED_KEYS = [
    {"mods":"ctrlshift","key":"F","keys":"ctrl-shift-f","action":"searchDeep","context":"listing","frontend":"all","preset":"all","code":"Key_F","text":"","ctrl":true,"shift":true,"alt":false,"super":false,"keycode":Qt.Key_F,"mask":(Qt.ControlModifier | Qt.ShiftModifier)},
    ...
    {"mods":"ctrl","key":"J","keys":"ctrl-j","action":"sortName","context":"listing","frontend":"all","preset":"all","code":"Key_J","text":"","ctrl":true,"shift":false,"alt":false,"super":false,"keycode":Qt.Key_J,"mask":(Qt.ControlModifier)},
    {"mods":"ctrl","key":"K","keys":"ctrl-k","action":"sortSize","context":"listing","frontend":"all","preset":"all","code":"Key_K","text":"","ctrl":true,"shift":false,"alt":false,"super":false,"keycode":Qt.Key_K,"mask":(Qt.ControlModifier)},
    {"mods":"ctrl","key":"L","keys":"ctrl-l","action":"sortDate","context":"listing","frontend":"all","preset":"all","code":"Key_L","text":"","ctrl":true,"shift":false,"alt":false,"super":false,"keycode":Qt.Key_L,"mask":(Qt.ControlModifier)},
    ...
    {"mods":"none","key":"F5","keys":"f5","action":"refresh","context":"listing","frontend":"all","preset":"all","code":"Key_F5","text":"","ctrl":false,"shift":false,"alt":false,"super":false,"keycode":Qt.Key_F5,"mask":(0)},
...
var BASE_SHEET = [{"keys":"down up","action":"cursorDown","label":"move"},{"keys":"enter","action":"open","label":"open"},{"keys":"left","action":"parent","label":"parent"},{"keys":"right","action":"pageForward","label":"open / preview"},{"keys":"space","action":"toggleSelect","label":"select"},{"keys":"^a","action":"selectAll","label":"select all"},{"keys":"^f ^F","action":"search","label":"find / deep"},{"keys":"^j ^k ^l","action":"sortName","label":"sort"},{"keys":"tab","action":"focusNext","label":"scope / focus"},{"keys":"^g","action":"sidebar","label":"sidebar"},{"keys":"^c","action":"copy","label":"copy"},{"keys":"^b","action":"copypath","label":"file path"},{"keys":"^x","action":"cut","label":"cut"},{"keys":"^v","action":"paste","label":"paste"},{"keys":"f2","action":"rename","label":"rename"},{"keys":"f5","action":"refresh","label":"reload"},{"keys":"delete","action":"trash","label":"trash"},{"keys":"^z","action":"undo","label":"undo"},{"keys":"^N","action":"newFolder","label":"new folder"},{"keys":"m","action":"menu","label":"menu"},{"keys":",","action":"settings","label":"settings"},{"keys":"?","action":"keymapSheet","label":"keys"}]
var SHEET_GROUPS = {"move":["cursorDown","cursorUp","open","parent","pageForward","focusNext","escape","toggleSelect","selectAll"],"look":["preview","sidebar","toggleDual","toggleHidden","mute","keymapSheet","refresh"],"find":["search","searchDeep","sortName","sortSize","sortDate"],"change":["copy","cut","paste","copypath","rename","trash","undo","newFolder","newFile","menu","settings"]}
