...
var BASE_SHEET = [{"keys":"down up","action":"cursorDown","label":"move"},{"keys":"enter","action":"open","label":"open"},{"keys":"left","action":"parent","label":"parent"},{"keys":"right","action":"pageForward","label":"open / preview"},{"keys":"space","action":"toggleSelect","label":"select"},{"keys":"^a","action":"selectAll","label":"select all"},{"keys":"^f","action":"search","label":"find"},{"keys":"tab","action":"focusNext","label":"scope / focus"},{"keys":"^g","action":"sidebar","label":"sidebar"},{"keys":"^c","action":"copy","label":"copy"},{"keys":"^b","action":"copypath","label":"file path"},{"keys":"^x","action":"cut","label":"cut"},{"keys":"^v","action":"paste","label":"paste"},{"keys":"f2","action":"rename","label":"rename"},{"keys":"f5","action":"refresh","label":"reload"},{"keys":"delete","action":"trash","label":"trash"},{"keys":"^z","action":"undo","label":"undo"},{"keys":"^N","action":"newFolder","label":"new folder"},{"keys":"m","action":"menu","label":"menu"},{"keys":",","action":"settings","label":"settings"},{"keys":"?","action":"keymapSheet","label":"keys"}]
var SHEET_GROUPS = {"move":["cursorDown","cursorUp","open","parent","pageForward","focusNext","escape","toggleSelect","selectAll"],"look":["preview","sidebar","toggleDual","toggleHidden","mute","keymapSheet","refresh"],"find":["search"],"change":["copy","cut","paste","copypath","rename","trash","undo","newFolder","newFile","menu","settings"]}
